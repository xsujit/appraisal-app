...
INSERT INTO user (email, password, id) VALUES ('jack.bauer@mastek.com', '$2a$11$N82GiTabGmYk45vXnGPhG.2QnAOsAlrdHlamiA7o8LWFw45i0r8j2', '1000');
INSERT INTO auth_user_group (auth_group, user_id, id) VALUES ('USER', 1000, 2000);
INSERT INTO employee (first_name, id, last_name, location, project_id, user_id) VALUES ('Jack', 11227, 'Bauer', 'Glasgow', 2, 1000);
INSERT INTO user (email, password, id) VALUES ('james.bond@mastek.com', '$2a$11$N82GiTabGmYk45vXnGPhG.2QnAOsAlrdHlamiA7o8LWFw45i0r8j2', '1001');
INSERT INTO auth_user_group (auth_group, user_id, id) VALUES ('USER', 1001, 2001);
INSERT INTO employee (first_name, id, last_name, location, project_id, user_id) VALUES ('James', 11228, 'Bond', 'Glasgow', 2, 1001);
INSERT INTO user (email, password, id) VALUES ('stuart.little@mastek.com', '$2a$11$N82GiTabGmYk45vXnGPhG.2QnAOsAlrdHlamiA7o8LWFw45i0r8j2', '1002');
INSERT INTO auth_user_group (auth_group, user_id, id) VALUES ('USER', 1002, 2002);
INSERT INTO employee (first_name, id, last_name, location, project_id, user_id) VALUES ('Stuart', 11229, 'Little', 'Mumbai', 1, 1002);
