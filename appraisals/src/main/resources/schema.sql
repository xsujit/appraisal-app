 ...
 create table appraisal (description text not null, last_update_date timestamp, signed_off boolean, submit_date timestamp, optlock bigint, employee_id bigint not null, appraisal_type tinyint not null, appraisal_year date not null, project_id bigint not null, primary key (appraisal_type, appraisal_year, employee_id));
 ...
 create table comment (id bigint not null, message text not null, submit_date timestamp, appraisal_appraisal_type tinyint not null, appraisal_appraisal_year date not null, appraisal_employee_id bigint not null, commenter_employee_id bigint not null, primary key (id));
 create table employee (first_name varchar(255) not null, id bigint not null, last_name varchar(255) not null, location varchar(255) not null, user_id bigint not null, project_id bigint not null, primary key (user_id));
 create table project (id bigint not null, description varchar(255), title varchar(255), primary key (id));
 create table user (id bigint not null, email varchar(255) not null, password varchar(255) not null, primary key (id));
 create table vote (submit_date timestamp, voter_employee_id bigint not null, appraisal_appraisal_type tinyint not null, appraisal_appraisal_year date not null, appraisal_employee_id bigint not null, primary key (appraisal_appraisal_type, appraisal_appraisal_year, appraisal_employee_id, voter_employee_id));
 ...
 alter table employee add constraint FKt7hn4e5o1y2vv3gawqldhhsj8 foreign key (project_id) references project;
